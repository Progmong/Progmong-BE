...
public class MypageFacadeService {
    ...
    public MyPageDto getMypage(Long userId) {
        ...
        // 3. 최근 탐험 기록 (5개)
        RecommendProblemListResponseDto2 recentExplores = exploreService.getRecentProblemRecords(userId, 0, 5);
        // 4. 관심 태그
        List<InterestTagResponseDto> interestTags = tagService.getUserInterestTags(user.getId());
